        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                ...
                <div class="col-12 my-5">
                    <img src="https://res.cloudinary.com/dzybbktyr/image/upload/v1712300214/shldresources/lvl01_MU7gX05SUlAN58Z_funvi5.jpg" alt="">
                ...
                <div class="col-12 mt-3 mb-5">
                    ...
                    <div class="mt-4">
                        ...
                        $result = mysqli_query($conn, "SELECT * from hints where level='1' order by hint_number");
                        if ($result)
