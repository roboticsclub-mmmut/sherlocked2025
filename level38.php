...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST["answer"]) and isset($_POST["submit"])) {
        $result = mysqli_query($conn, "SELECT * from levels where level='38';");
...
<head>
    ...
    <title>LEVEL 38 · Sherlocked · ROBOMANIA 2024
    </title>
    ...
    <header class="my-5">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 class="sub-title-heading display-5">LEVEL 38</h1>
                </div>
                <div class="col-12 my-5">
                    <img src="https://res.cloudinary.com/dzybbktyr/image/upload/v1712299788/shldresources/lvl38_LgwQwDjyIEVdUCn_ewboqd.jpg" alt="">
                ...
                <div class="col-12 mt-3 mb-5">
                    ...
                    <div class="mt-4">
                        ...
                        $result = mysqli_query($conn, "SELECT * from hints where level='38' order by hint_number");
                        if ($result)
