...
<head>
    ...
    <title>LEVEL 18 · Sherlocked · ROBOMANIA 2024
    </title>
    ...
    <header class="my-5">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 class="sub-title-heading display-5">LEVEL 18</h1>
                </div>
                <div class="col-12 my-5">
                    <img src="https://res.cloudinary.com/dzybbktyr/image/upload/v1712299749/shldresources/lvl18_WbhjfaCyeEvDWyD_h5urtm.jpg" alt="">
                ...
                <div class="col-12 mt-3 mb-5">
                    ...
                    <div class="mt-4">
                        ...
                        $result = mysqli_query($conn, "SELECT * from hints where level='18' order by hint_number");
                        if ($result)
